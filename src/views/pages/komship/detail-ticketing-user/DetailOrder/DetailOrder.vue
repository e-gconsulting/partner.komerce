...
export default {
  ...
  methods: {
    ...
    cancelOrder() {
      ...
      this.$swal.fire({
        ...
        if (isConfirm.value === true) {
          this.$http_komship.delete(`v1/order/${this.profile.partner_id}/delete/${this.idOrder}`)
            .then(() => {
    ...
    cancelPickup() {
      ...
      this.$http_komship.put(`/v2/order/${this.profile.partner_id}/cancel/${this.idOrder}`)
        .then(() => {
    ...
    handleDetailOrder() {
      this.$emit('updateValueDetailOrderMode')
    },
  },
}
</script>
